    ...
    >
      <div className="w-full max-w-md p-8 bg-black/50 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20">
        <h2 className="text-3xl font-semibold text-center text-white mb-8">
          {isRegistered ? "Registration Complete" : "Create Account"}
        </h2>
        {errorMessage && (
        ...
        {isRegistered ? (
          <div className="text-center text-white">
            ...
            <button
              ...
              className="w-full py-3 bg-green-600 hover:bg-green-700 text-white rounded-xl transition-all duration-200 hover:scale-105"
            >
              LOGIN NOW
            </button>
          </div>
          ...
          <>
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* KEEP YOUR ENTIRE EXISTING SIGNUP FORM HERE */}
            </form>

            <div className="mt-6 text-center text-white/70 text-sm space-y-2">
              {/* KEEP YOUR EXISTING "Already have an account?" AND
          CONDITIONS OF USE SECTION HERE */}
              <form onSubmit={handleSubmit} className="space-y-6">
